...
That way we do not have to provide in Service construction above creators. When SDI find that there is no
explicit creator, then it will take necessary default one.
