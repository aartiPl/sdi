...
That way we can get any specification of a class from the class hierarchy of App without worrying about dependencies.
...
to initialize and shutdown specification of the class. In Manageable we can find additionally two methods:
start() and stop().
